...
class inf_model(nn.Module):
    def __init__(self, input_vocab, output_vocab, embed_dim=512, num_heads=8, dropout_rate=0.1):
        ...
        self.lemma_encoder  = Encoder(len(input_vocab),   embed_dim, num_heads, dropout_rate)
        self.tag_encoder    = Encoder(len(input_vocab),     embed_dim, num_heads, dropout_rate)
        self.source_encoder = Encoder(len(input_vocab),  embed_dim, num_heads, dropout_rate)
